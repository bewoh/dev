...
<!--[if gt IE 9]><!-->	<html> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{$baseUrl}css/fonts/font-awesome/css/font-awesome.css">
        <link rel="stylesheet" href="{$baseUrl}vendor/flexslider/flexslider.css" media="screen" />
        <link rel="stylesheet" href="{$baseUrl}vendor/magnific-popup/magnific-popup.css" media="screen" />

        <!-- Theme CSS -->
        <link rel="stylesheet" href="{$baseUrl}css/theme.css">
        <link rel="stylesheet" href="{$baseUrl}css/theme-elements.css">
        <link rel="stylesheet" href="{$baseUrl}css/theme-animate.css">

        <!-- Current Page Styles -->
        <link rel="stylesheet" href="{$baseUrl}vendor/revolution-slider/css/settings.css" media="screen" />
        <link rel="stylesheet" href="{$baseUrl}vendor/revolution-slider/css/captions.css" media="screen" />
        <link rel="stylesheet" href="{$baseUrl}vendor/circle-flip-slideshow/css/component.css" media="screen" />

        <!-- Custom CSS -->
        <link rel="stylesheet" href="{$baseUrl}css/custom.css">

        <!-- Skin CSS -->
        <link rel="stylesheet" href="{$baseUrl}css/skins/blue.css">

        <!-- Responsive CSS -->
        <link rel="stylesheet" href="{$baseUrl}css/bootstrap-responsive.css" />
        <link rel="stylesheet" href="{$baseUrl}css/theme-responsive.css" />
        ...
        <!-- Head Libs -->
        <script src="{$baseUrl}vendor/modernizr.js"></script>
            ...
            <div role="main" class="main">
                <div id="content" class="content full">
                    ...
                    <div class="container">
                        ...
                        <div class="row center">
                            <div class="flexslider unstyled" data-plugin-options='{literal}{"directionNav":false, "animation":"slide", "slideshow": false, "maxVisibleItems": 6}{/literal}'>
                                <ul class="slides">
                                    <li>
                                        <div class="span2">
                                ...
                                <div class="row">
                                    <div class="span6">
                                        <div class="recent-posts">
                                            ...
                                            <div class="row">
                                                <div class="flexslider unstyled" data-plugin-options='{literal}{"directionNav":false, "animation":"slide"}{/literal}'>
                                                    <ul class="slides">
                                                        <li>
                                                            <div class="span3">
                                                                <article>
                                    ...
                                    <div class="span6">
                                        ...
                                        <div class="row">
                                            <div class="flexslider flexslider-top-title unstyled" data-plugin-options='{literal}{"controlNav":false, "slideshow": false, "animationLoop": true, "animation":"slide"}{/literal}'>
                                                <ul class="slides">
                                                    <li>
                                                        <div class="span6">
